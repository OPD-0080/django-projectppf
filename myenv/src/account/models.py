...
class UserModel(AbstractBaseUser):
    ...
    middle_name = models.CharField(default='', blank=True, null=True, max_length=100)
    contact_number = models.CharField(default='', blank=True, null=True, max_length=20)
    company = models.CharField(default='', blank=True, null=True, max_length=100)
    department = models.CharField(default='', blank=True, null=True, max_length=100)
    userID = models.CharField(default='', blank=True, null=True, max_length=20)
    photo = models.CharField(default='', blank=True, null=True, max_length=100)
    ID_card_type = models.CharField(default='', blank=True, null=True, max_length=100, choices=ID_CARD_TYPE)
    ID_card_number = models.CharField(default='', blank=True, null=True, max_length=100)
    ID_photo_front = models.CharField(default='', blank=True, null=True, max_length=100)
    ID_photo_back = models.CharField(default='', blank=True, null=True, max_length=100)
    otp = models.CharField(default='Null', blank=True, null=True, max_length=20)
    role = models.CharField(default='', blank=True, null=True, max_length=20)
...
class RegistrationModel(AbstractBaseUser):
    ...
    ceo = models.CharField(default='', blank=True, null=True, max_length=100)
    role = models.CharField(default='superuser', blank=True, null=True, max_length=100)
